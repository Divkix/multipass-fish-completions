...
complete -c multipass -n "__fish_use_subcommand" -f -a "authenticate" -d 'Authenticate with the Multipass service'
...
# delete command
complete -c multipass -n "__fish_use_subcommand" -a "delete" -d "Delete instances"
...
# info command
complete -c multipass -n "__fish_use_subcommand" -f -a "info" -d 'Display information about instances'complete -c multipass -n "__fish_seen_subcommand_from info" -s h -l help -d "Display help"
